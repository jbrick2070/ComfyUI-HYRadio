...
NODE_CLASS_MAPPINGS = {"HYRadio_BatchProceduralSFX": BatchProceduralSFX}
NODE_DISPLAY_NAME_MAPPINGS = {"HYRadio_BatchProceduralSFX": "[FAST] Batch Procedural SFX (Obsidian)"}
