...
NODE_CLASS_MAPPINGS = {"HYRadio_BatchAudioGenGenerator": BatchAudioGenGenerator}
NODE_DISPLAY_NAME_MAPPINGS = {"HYRadio_BatchAudioGenGenerator": "[FAST] Batch AudioGen (Foley)"}
