...
DEFAULT_OUT = os.path.join(os.path.expanduser("~"), "Documents", "ComfyUI", "output", "hyradio")
...
class EpisodeAssembler:
    ...
    def assemble(self, scene_audio, episode_title,
        ...
        # Video-only pipeline - MP4 is written by HYRadio_SignalLostVideo.
        # No WAV or PNG files are saved here.
        output_path = "(video-only - MP4 written by HYRadio_SignalLostVideo)"
