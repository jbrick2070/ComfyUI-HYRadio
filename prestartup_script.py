...
logging.getLogger("HYRadio").info("HYRadio prestartup: HF_HOME=%s | safetensors_conversion mocked EARLY", os.environ.get("HF_HOME"))
print("✅ [HYRadio] prestartup: safetensors_conversion mocked before any transformers import")
