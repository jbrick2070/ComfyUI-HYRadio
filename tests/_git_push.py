...
REPO = r"C:\Users\jeffr\Documents\ComfyUI\custom_nodes\ComfyUI_HYWorld2"
...
files = [
    ...
    "tests/test_core.py",
    "BUG_LOG.md",
    "visual_sidecar/__init__.py",
    "visual_sidecar/subprocess_runners/__init__.py",
    "visual_sidecar/schema/visual_plan.schema.json",
...
if TOKEN:
    remote = f"https://jbrick2070:{TOKEN}@github.com/jbrick2070/ComfyUI_HYWorld2.git"
