# HYRadio Pipeline LLM Prompts - QA Reference
...
|---------|-------|-------------|
| HYRadio_LLMScriptWriter | LLMScriptWriter | LLM Story Writer |
| HYRadio_LLMDirector | LLMDirector | LLM Director |
| HYRadio_BarkTTS | BarkTTSNode | Bark TTS (Suno) |
| HYRadio_SFXGenerator | SFXGenerator | SFX Generator |
| HYRadio_SceneSequencer | SceneSequencer | Scene Sequencer |
| HYRadio_EpisodeAssembler | EpisodeAssembler | Episode Assembler |
| HYRadio_AudioEnhance | AudioEnhance | Spatial Audio Enhance |
| HYRadio_BatchBarkGenerator | BatchBarkGenerator | Batch Bark Generator |
| HYRadio_BatchKokoroGenerator | BatchKokoroGenerator | Batch Kokoro (4GB) |
| HYRadio_BatchAudioGenGenerator | BatchAudioGenGenerator | Batch AudioGen (Foley) |
| HYRadio_BatchProceduralSFX | BatchProceduralSFX | Batch Procedural SFX (Obsidian) |
| HYRadio_SignalLostVideo | SignalLostVideoRenderer | Signal Lost Video |
| HYRadio_ProjectStateLoader | ProjectStateLoader | Project State Loader |
| HYRadio_KokoroAnnouncer | KokoroAnnouncer | Kokoro Announcer |
| HYRadio_MusicGenTheme | MusicGenTheme | MusicGen Theme |
| HYRadio_VRAMGuardian | VRAMGuardian | VRAM Guardian |

All nodes also register legacy aliases (without HYRadio_ prefix) for backward compatibility.
