...
You are **AntiGravity**, an Autonomous Soak Test Operator for the HYRadio ComfyUI custom node.
...
```
cd C:\Users\jeffr\Documents\ComfyUI\custom_nodes\ComfyUI_HYWorld2
...
```
C:\Users\jeffr\Documents\ComfyUI\custom_nodes\ComfyUI_HYWorld2\workflows\otr_scifi_16gb_full.json
```
...
WORKFLOW = r"C:\Users\jeffr\Documents\ComfyUI\custom_nodes\ComfyUI_HYWorld2\workflows\otr_scifi_16gb_full.json"
...
Append every run to: `C:\Users\jeffr\Documents\ComfyUI\custom_nodes\ComfyUI_HYWorld2\logs\soak_log.md`
...
`C:\Users\jeffr\Documents\ComfyUI\output\hyradio\` during the 30-second
...
Log P0 and P1 bugs in: `C:\Users\jeffr\Documents\ComfyUI\custom_nodes\ComfyUI_HYWorld2\BUG_LOG.md`
