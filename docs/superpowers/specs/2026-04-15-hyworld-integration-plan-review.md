...
The reviewer's schema was both over- and under-specified: `scene_id` locked the format to a concatenated SHA prefix, the string-length caps were arbitrary, and the required-field set did not match what the HYRadio Director actually emits. Leaner version:

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "HYRadio_Director_Scene_Schema",
  "type": "object",
...
- HYRadio v2 Design Spec: `docs/superpowers/specs/2026-04-12-otr-v2-visual-sidecar-design.md`
- HYRadio v2.1 Spec: `docs/superpowers/specs/2026-04-14-otr-v2.1-spec.md`
...
### K4. `episode_title` socket input on `HYRadio_SignalLostVideo`
